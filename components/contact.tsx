  ...
  const contactInfo = [
    {
      ...
      title: "Email",
      value: "ahmadkhalid6564@gmail.com",
      link: "mailto:ahmadkhalid6564@gmail.com",
    },
    {
                  ...
                  <CardContent className="p-6">
                    ...
                    <div className="flex gap-4">
                      <Button variant="outline" size="icon" asChild>
                        <a href="https://github.com/Ahmad6564" target="_blank" rel="noopener noreferrer">
                          <svg
                      ...
                      <Button variant="outline" size="icon" asChild>
                        <a href="https://www.linkedin.com/in/ahmad-khalid-846830201/" target="_blank" rel="noopener noreferrer">
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="24"
                            height="24"
                      ...
                      <Button variant="outline" size="icon" asChild>
                        <a href="mailto:ahmadkhalid6564@gmail.com">
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="24"
                            height="24"
                      ...
                      <Button variant="outline" size="icon" asChild>
                        <a href="https://medium.com/@ahmadkhalid6564" target="_blank" rel="noopener noreferrer">
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="24"
                            height="24"
